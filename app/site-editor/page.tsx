...
export default function SiteEditorPage() {
  ...
  const [siteContent, setSiteContent] = useState({
    ...
    metaDescription: "Discover the latest trends in fashion and style at Joantees. Shop our curated collection of clothing and accessories.",
    primaryColor: "#3b82f6",
  ...
  const [footerContent, setFooterContent] = useState({
    ...
    description: "Your premier destination for fashion and style. We bring you the latest trends and timeless classics.",
    ...
    newsletterDescription: "Get the latest fashion updates and exclusive offers."
  })
  ...
  const [socialLinks, setSocialLinks] = useState<SocialLink[]>([
    { id: "1", platform: "Facebook", url: "https://facebook.com/joantees", icon: "facebook" },
    { id: "2", platform: "Instagram", url: "https://instagram.com/joantees", icon: "instagram" },
    { id: "3", platform: "Twitter", url: "https://twitter.com/joantees", icon: "twitter" },
    { id: "4", platform: "YouTube", url: "https://youtube.com/joantees", icon: "youtube" }
  ])
  ...
  const [pages, setPages] = useState<PageContent[]>([
    {
      ...
      title: "About Us",
      slug: "about",
      content: "<h1>About Joantees</h1><p>We are passionate about fashion and committed to bringing you the best in style and quality.</p>",
      metaTitle: "About Us - Joantees",
      metaDescription: "Learn about Joantees, your premier fashion destination.",
      isPublished: true
    },
    {
      id: "2",
  ...
  const [newLink, setNewLink] = useState({ title: "", url: "", target: "_self" as "_self" | "_blank" })
  const [newSocial, setNewSocial] = useState({ platform: "", url: "", icon: "" })
  const [newPage, setNewPage] = useState({ title: "", slug: "", content: "", metaTitle: "", metaDescription: "" })
  ...
  const fontOptions = [
    ...
    { name: "Montserrat", category: "Sans-serif", weight: "300, 400, 500, 600, 700" },
    { name: "Poppins", category: "Sans-serif", weight: "300, 400, 500, 600, 700" },
    { name: "Playfair Display", category: "Serif", weight: "400, 500, 600, 700" },
    { name: "Merriweather", category: "Serif", weight: "300, 400, 700" },
    { name: "Source Code Pro", category: "Monospace", weight: "300, 400, 500, 600" },
  ...
  const addPage = () => {
    ...
    setNewPage({ title: "", slug: "", content: "", metaTitle: "", metaDescription: "" })
  ...
  const getSocialIcon = (icon: string) => {
    switch (icon) {
      case "facebook": return <IconBrandFacebook className="h-4 w-4" />
      case "instagram": return <IconBrandInstagram className="h-4 w-4" />
      case "twitter": return <IconBrandTwitter className="h-4 w-4" />
      case "youtube": return <IconBrandYoutube className="h-4 w-4" />
      case "linkedin": return <IconBrandLinkedin className="h-4 w-4" />
      case "tiktok": return <IconBrandTiktok className="h-4 w-4" />
      case "pinterest": return <IconBrandPinterest className="h-4 w-4" />
      case "snapchat": return <IconBrandSnapchat className="h-4 w-4" />
      case "discord": return <IconBrandDiscord className="h-4 w-4" />
      case "telegram": return <IconBrandTelegram className="h-4 w-4" />
      default: return <IconLink className="h-4 w-4" />
    }
  }
                            ...
                            <DialogContent>
                              ...
                              <div className="space-y-4">
                                ...
                                <div>
                                  ...
                                  <Select value={newLink.target} onValueChange={(value: "_self" | "_blank") => setNewLink({ ...newLink, target: value })}>
                                    <SelectTrigger>
                                      <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                            ...
                            <DialogContent>
                              ...
                              <div className="space-y-4">
                                <div>
                                  ...
                                  <Select value={newSocial.platform} onValueChange={(value) => setNewSocial({ ...newSocial, platform: value, icon: value.toLowerCase() })}>
                                    <SelectTrigger>
                                ...
                                <div className="flex justify-end space-x-2">
                                  <Button variant="outline" onClick={() => setIsAddSocialDialogOpen(false)}>
                                    Cancel
                                  </Button>
                        ...
                        <div className="space-y-4">
                            ...
                            <div key={social.id} className="p-4 border rounded-lg space-y-3">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <h4 className="font-medium">Edit {social.platform}</h4>
                                </div>
                                <Button
                                  variant="outline"
                                  size="sm"
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                  <Label htmlFor={`platform-${social.id}`}>Platform</Label>
                                  <Select 
                                    value={social.platform} 
                                    onValueChange={(value) => updateSocialLink(social.id, 'platform', value)}
                                  >
                                    <SelectTrigger>
                                      <SelectValue placeholder="Select platform" />
                                    </SelectTrigger>
                              ...
                              <div className="flex items-center space-x-2">
                                <Label htmlFor={`icon-${social.id}`}>Icon</Label>
                                <Select 
                                  value={social.icon} 
                          ...
                          {socialLinks.length === 0 && (
                            <div className="text-center py-8 text-muted-foreground">
                              ...
                              <p className="text-sm">Click &quot;Add Social&quot; to get started</p>
                            </div>
                          )}
                          </div>
                        </CardContent>
                    ...
                    <CardContent>
                      <div className="bg-gray-900 text-white p-6 rounded-lg">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div>
                            <h3 className="font-bold text-lg mb-3">{footerContent.companyName}</h3>
                            <p className="text-gray-300 text-sm mb-4">{footerContent.description}</p>
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              {footerLinks.slice(0, 4).map((link) => (
                                <div key={link.id}>
                                  <a href={link.url} className="text-gray-300 hover:text-white text-sm">
                                    {link.title}
                                  </a>
                                </div>
                              ))}
                          ...
                          <div>
                            ...
                            {footerContent.showNewsletter && (
                              <div className="mt-6">
                                <h4 className="font-semibold mb-2">{footerContent.newsletterTitle}</h4>
                                <p className="text-gray-300 text-sm mb-3">{footerContent.newsletterDescription}</p>
                                <div className="flex">
                                  <Input placeholder="Enter email" className="bg-gray-800 border-gray-700" />
                        ...
                        <div className="flex justify-between items-center text-sm text-gray-300">
                          ...
                          <div className="flex space-x-4">
                            {footerLinks.slice(4).map((link) => (
                              <a key={link.id} href={link.url} className="hover:text-white">
                                {link.title}
                              </a>
                            ))}
                          </div>
                      ...
                      <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        <div className="flex items-center text-blue-800 text-sm">
                          ...
                          <span className="ml-2">This preview will automatically sync with your website footer when you save changes.</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => updatePage(selectedPage.id, { metaTitle: e.target.value })}
                          />
                        </div>
                        <div>
                          ...
                          <Textarea
                            ...
                            onChange={(e) => updatePage(selectedPage.id, { metaDescription: e.target.value })}
                            rows={2}
                          />
                        </div>
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            onChange={(e) => updatePage(selectedPage.id, { isPublished: e.target.checked })}
                            className="rounded"
                          />
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <Select value={siteContent.headingFont} onValueChange={(value) => handleInputChange("headingFont", value)}>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      <div>
                        ...
                        <Select value={siteContent.bodyFont} onValueChange={(value) => handleInputChange("bodyFont", value)}>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      <div>
                        ...
                        <Select value={siteContent.fontSize} onValueChange={(value) => handleInputChange("fontSize", value)}>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      <div>
                        ...
                        <Select value={siteContent.lineHeight} onValueChange={(value) => handleInputChange("lineHeight", value)}>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      <div>
                        ...
                        <Select value={siteContent.borderRadius} onValueChange={(value) => handleInputChange("borderRadius", value)}>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                            ...
                            <SelectItem value="12px">12px (Very Rounded)</SelectItem>
                      ...
                      <div>
                        ...
                        <Select value={siteContent.shadowIntensity} onValueChange={(value) => handleInputChange("shadowIntensity", value)}>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                  ...
                  <CardContent>
                    <div 
                      ...
                      style={{ 
                        ...
                        boxShadow: siteContent.shadowIntensity === 'none' ? 'none' : 
                  ...
                  <CardContent>
                    <div className="grid grid-cols-5 gap-4">
                      <div className="text-center">
                        ...
                        <p className="text-xs text-muted-foreground">{siteContent.primaryColor}</p>
                      </div>
                      <div className="text-center">
                        <div 
                          className="w-16 h-16 rounded-lg border mx-auto mb-2"
                        ...
                        <p className="text-xs text-muted-foreground">{siteContent.secondaryColor}</p>
                      </div>
                      <div className="text-center">
                        <div 
                          className="w-16 h-16 rounded-lg border mx-auto mb-2"
                        ...
                        <p className="text-xs text-muted-foreground">{siteContent.accentColor}</p>
                      </div>
                      <div className="text-center">
                        <div 
                          className="w-16 h-16 rounded-lg border mx-auto mb-2"
                          style={{ backgroundColor: siteContent.backgroundColor }}
                        />
                        <p className="text-sm font-medium">Background</p>
                        <p className="text-xs text-muted-foreground">{siteContent.backgroundColor}</p>
                      </div>
                      <div className="text-center">
                        <div 
                          className="w-16 h-16 rounded-lg border mx-auto mb-2"
                        ...
                        <p className="text-xs text-muted-foreground">{siteContent.textColor}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                        ...
                        <div className="space-y-3">
                          <div>
                            <h3 className="text-blue-600 text-lg font-medium leading-tight">
                              {siteContent.metaTitle || "Your page title will appear here"}
                            </h3>
                          ...
                          <p className="text-gray-600 text-sm leading-relaxed">
                            {siteContent.metaDescription || "Your meta description will appear here. This is what users see in search results."}
                          </p>
                        </div>
                      </div>
                      
                      <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <h4 className="font-medium text-yellow-800 mb-2">SEO Checklist</h4>
                        <div className="space-y-1 text-sm">
                          <div className="flex items-center space-x-2">
                            <div className={`w-2 h-2 rounded-full ${siteContent.metaTitle ? 'bg-green-500' : 'bg-red-500'}`} />
                            <span>Meta title set</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className={`w-2 h-2 rounded-full ${siteContent.metaDescription ? 'bg-green-500' : 'bg-red-500'}`} />
