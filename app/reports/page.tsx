    ...
    <div className="space-y-6">
      ...
      <div className="flex space-x-1 bg-gray-100 p-1 rounded-lg">
        {[
          ...
          { id: "profit", label: "Profit Margins", icon: IconTrendingUp },
          { id: "sales", label: "Sales Trends", icon: IconShoppingCart },
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <IconCurrencyDollar className="h-8 w-8 text-green-600" />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {overallMetrics ? overallMetrics.totalOrders : "—"}
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {overallMetrics
                        ? formatCurrency(overallMetrics.grossProfit)
                        : "—"}
                    </p>
                  </div>
              ...
              <CardContent className="p6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {overallMetrics
                        ? `${overallMetrics.profitMarginPercent.toFixed(1)}%`
                        : "—"}
                    </p>
                  </div>
                ...
                <TableBody>
                  {profitMargins.map((product) => (
                    <TableRow key={product.id}>
                      ...
                      >
                        {formatCurrency(product.profitMargin.profit)}
                      </TableCell>
                      <TableCell
                        className={getProfitMarginColor(
                      ...
                      <TableCell>
                        <div className="text-sm">
                          <p>{product.sales.totalQuantitySold} sold</p>
                          <p className="text-gray-600">
                            {formatCurrency(product.sales.totalRevenue)}
                          </p>
                        </div>
                      </TableCell>
                    </TableRow>
              ...
              <Table>
                ...
                <TableBody>
                  {salesTrends.map((trend, index) => (
                    <TableRow key={index}>
                      <TableCell>{formatDate(trend.period)}</TableCell>
                      ...
                      <TableCell>{trend.uniqueCustomers}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {inventorySummary ? inventorySummary.totalProducts : "—"}
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {customerSummary ? customerSummary.totalCustomers : "—"}
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {customerSummary ? customerSummary.activeCustomers : "—"}
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {customerSummary ? customerSummary.recentCustomers : "—"}
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {customerSummary
                        ? formatCurrency(customerSummary.averageCustomerValue)
                        : "—"}
                    </p>
                  </div>
                  <IconCurrencyDollar className="h-8 w-8 text-yellow-600" />
                </div>
              </CardContent>
            </Card>
          </div>
              ...
              <Table>
                ...
                <TableBody>
                  {acquisitionTrends.map((trend, index) => (
                    <TableRow key={index}>
                      <TableCell>{formatDate(trend.month)}</TableCell>
